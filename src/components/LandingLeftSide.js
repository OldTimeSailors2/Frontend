...
const LandingLeftSide = () => {
  ...
  return (
    <div className="flex justify-between ">
      <div
        className={`flex flex-col items-center justify-center   xl:ml-4 1xl:ml-[1.15rem] 1xxl:ml-4  4k:ml-14   xl:mt-[120px] 1xl:mt-[115px] 1xxl:mt-[135px]  fullHD:mt-[190px] 2k:mt-[310px] 4k:mt-[390px]  ${
          isSafari
      ...
      >
        <Image
          ...
          height={100}
          alt="Text image"
          className={`self-center xl:w-[90px] xl:h-auto 1xl:w-[85px] 1xxl:w-[110px] fullHD:w-[150px] 2k:w-[280px] 4k:w-[300px] ${
            isSafari
        ...
        <div
          className={`grid grid-cols-2 gap-2 xs2:gap-2.5 min-[820px]:gap-3.5 xl:gap-2 fullHD:gap-4 2k:gap-6 4k:gap-9  xl:mt-7 1xl:mt-1.5 1xxl:mt-7  fullHD:mt-4 2k:mt-8 4k:mt-14
