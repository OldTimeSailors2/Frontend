    ...
    <div className="w-full px-0.5 min-[600px]:px-3 xl:px-4 flex xl:flex-col xl:items-center">
      ...
      >
        ...
        <button
          ...
          className={`services-hexagon-2 transition-all ease-in duration-300 ${activeService === "festival-and-event-organization" ? "before:bg-redPattern text-beige " : "before:bg-beigePattern text-darkBlue"} before:bg-contain z-[10] flex justify-center items-center text-lg leading-5 xs:leading-6 xs2:text-xl xs2:leading-[26px]  md1:text-[22px] md1:leading-5 md:text-3xl md:leading-[25px] md3:leading-7 lg:text-4xl xl:leading-7 xl:text-[27px] 1xxl:text-3xl fullHD:text-4xl 2k:text-5xl 4k:text-7xl  font-titles text-center`}
        >
        ...
        <button
          ...
          className={`services-hexagon-2 transition-all ease-in duration-300 ${activeService === "festival-within-a-festival" ? "before:bg-redPattern text-beige " : "before:bg-beigePattern text-darkBlue"} before:bg-contain z-[10] flex justify-center items-center text-xl xs2:text-xl leading-6 xs2:leading-6  md1:text-[22px] md1:leading-6 md:text-3xl md:leading-[25px] md3:leading-7 lg:text-4xl xl:text-[27px] xl:leading-7  1xxl:text-3xl fullHD:text-4xl 2k:text-5xl 4k:text-7xl 1xl:leading-7 font-titles text-center`}
        >
        ...
        <button
          ...
          className={`services-hexagon-3 transition-all ease-in duration-300 ${activeService === "pirate-props-and-games" ? "before:bg-redPattern text-beige " : "before:bg-beigePattern text-darkBlue"} before:bg-contain z-[10] flex justify-center items-center text-xl xs2:text-xl xs2:leading-6 md1:text-[22px]  md:text-3xl md:leading-[25px] md3:leading-7 lg:text-4xl xl:text-[27px] xl:leading-7  leading-6  1xxl:text-3xl fullHD:text-4xl 2k:text-5xl 4k:text-7xl 1xl:leading-7 font-titles text-center`}
        >
      ...
      <div
        ...
        className="services-octagon bg-redPattern bg-contain flex flex-col justify-between py-2 xl:flex-row xl:items-center 1xl:gap-3 xl:px-9 4k:px-28  "
      >
        <div className="h-full max-xl:py-4 xl:max-w-[400px] fullHD:max-w-[500px] 2k:max-w-[750px] 4k:max-w-[1100px] flex items-center">
          <div className="flex flex-col w-full px-4 md:px-6 lg:px-8 xl:px-1.5 fullHD:px-8">
            ...
            {activeServiceData && (
              <p
                className="text-pretty text-beige text-lg max-h-[300px] xs:max-h-[330px] xs2:max-h-[360px] md1:max-h-[260px] md1:text-xl md:max-h-[300px] md:text-2xl md2:max-h-[340px] lg:text-4xl lg:max-h-[420px] xl:text-lg xl:max-h-[200px] 1xl:max-h-[220px] 1xxl:max-h-[240px] fullHD:text-2xl fullHD:max-h-[320px] 2k:text-3xl 2k:max-h-[410px] 4k:text-5xl 4k:max-h-[650px] font-txt leading-6 overflow-y-auto overflow-x-hidden"
        ...
        {isDevice === "mobile" || isDevice === "tablet" ? (
          <div className="w-full h-full px-1 md:px-2 lg:px-4">
            <Carousel
            ...
            >
              {activeServiceData.images.map((imageUrls, index) => (
                <div key={index}>
                  <Image
                    src={imageUrls.medium.url}
                    width={110}
                    height={110}
                    alt={`Image ${index + 1}`}
                    className="rounded-md w-[110px] h-[110px] xs:w-[120px] xs:h-[120px] xs2:w-[130px] xs2:h-[130px] md1:w-[170px] md1:h-[170px] md:w-[210px] md:h-[210px] md2:w-[240px] md2:h-[240px] lg:w-[300px] lg:h-[300px]"
                    onClick={() => handleClick(imageUrls.XL.url)}
                  />
                </div>
              ))}
            </Carousel>
            ...
            {activeServiceData.images.map((imageUrls, index) => (
              <div key={index} className="grid-photo">
                <Image
                  ...
                  height={180}
                  alt={`Image ${index + 1}`}
                  className="rounded-sm cursor-pointer w-[180px] h-[180px] 1xl:w-[200px] 1xl:h-[200px] 1xxl:w-[218px] 1xxl:h-[218px] fullHD:w-[310px] fullHD:h-[310px] 2k:w-[400px] 2k:h-[430px] 4k:w-[574px] 4k:h-[574px]"
                  onClick={() => handleClick(imageUrls.XL.url)}
                />
              </div>
            ))}
