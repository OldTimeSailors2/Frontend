    ...
    {/* Si pongo scroll poner overflow auto solo para mobile */}
      ...
      <div className="w-full h-full px-[17.5px] pt-[17.5px] xl:px-[28px] xl:pt-[28px] 2k:px-[52px] 2k:pt-[52px] 4k:px-[64px] 4k:pt-[64px] relative">
        ...
        <Image
          ...
          {/* Pages Buttons */}
          <div className="flex flex-col gap-1 xs:gap-1 md1:gap-3 xl:gap-2 1xxl:gap-3.5 min-[1536px]:gap-2 fullHD:gap-3.5 2k:gap-5 4k:gap-7 mt-1 min-[375px]:max-xs:mt-2 md1:mt-8 min-[820px]:mt-10 lg:mt-11 xl:mt-1.5 2k:mt-5 4k:mt-7      mr-4 min-[375px]:max-xs:mr-8 md1:mr-6 min-[820px]:mr-10 lg:mr-11 xl:mr-6 4k:mr-4">
        <Link
