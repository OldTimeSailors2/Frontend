...
const options = {
  autoConfig: true,  // Configura automáticamente las páginas vistas
  debug: false,      // Habilita el modo de depuración si es necesario
};
FacebookPixel.init(process.env.PIXEL_ID, null, options);
FacebookPixel.pageView(); // Registra una vista de página inicial
